...
-(void)encryWithPublicKey
{
    ...
    [manager POST:@"http://192.168.1.198/emoji/testrsa.json" parameters:@{@"result":_encryWithPublicKeyTextview.text} constructingBodyWithBlock:^(id<AFMultipartFormData>  _Nonnull formData) {
...
-(void)decryWithPriviteKey
{
    ...
    NSLog(@"%@",[self dictionaryWithJsonString:_dencryWithPriviteKeyTextview.text]);
